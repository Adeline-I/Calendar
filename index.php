...
$startYear = $actualYear - 100;
$endYear = $actualYear + 50;
...
$appointmentArray = [];
if (
    !empty($_POST['lastnameAppointment']) &&
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <div class="form-floating mb-3">
                                                                <input type="date" class="form-control" name="dateAppointment" id="dateAppointment" placeholder="Date" min="<?= $todayDay ?>">
                                                                <label for="dateAppointment">Date</label>
                                                            </div>
                                                            <p class="modalType">Type de rendez-vous :</p>
